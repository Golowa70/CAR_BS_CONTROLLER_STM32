...
#define IMAGE_LOGO_FK			FLASH_SECTOR_SIZE*1
#define IMAGE_LOGO_2			FLASH_SECTOR_SIZE*2
#define IMAGE_LOGO_3			FLASH_SECTOR_SIZE*3
#define IMAGE_LOGO_4			FLASH_SECTOR_SIZE*4
#define IMAGE_WATER_LEVEL		FLASH_SECTOR_SIZE*5
